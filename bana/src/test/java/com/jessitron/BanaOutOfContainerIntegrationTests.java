...
@SpringBootTest(classes = BanaApplication.class, properties = { "server.port=0", "spring.cloud.bus.enabled=false", "spring.cloud.discovery.enabled=false", "spring.cloud.consul.enabled=false" })
@WebAppConfiguration
public class BanaOutOfContainerIntegrationTests {
